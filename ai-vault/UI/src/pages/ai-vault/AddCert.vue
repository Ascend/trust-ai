    ...
    <div>
        ...
        >
          ...
          <el-form :model="certForm" :rules="certRules" ref="certForm" key="certKey">
            ...
            <el-form-item :label="$t('CFS_PASSWORD')" prop="password" :label-width="formLabelWidth">
            ...
            <el-form-item :label="$t('CERT_ORGANIZATION_NAME')" prop="organization"  :label-width="formLabelWidth">
              <el-tooltip :content="$t('TIP_COMMON')" placement="right">
            ...
            <el-form-item :label="$t('CERT_UNIT_NAME')" prop="unit"  :label-width="formLabelWidth">
              <el-tooltip :content="$t('TIP_COMMON')" placement="right">
            ...
            <el-row>
              <el-form-item :label="$t('CERT_LOCATION')" prop="country" :label-width="formLabelWidth" >
                <el-col :span="7">
