...
function print_usage() {
    ...
    echo "--online                online mode, do not specify when using container deployment"
    echo "--python-dir            specify the python directory where ansible is installed, default is /usr/local/python3.7.9, do not specify when using container deployment"
    echo "                        example: /usr/local/python3.7.9 or /usr/local/python3.7.9/"
    echo "--all                   all nodes perform configuration tasks,default only remote nodes, do not specify when using container deployment"
    echo "--exists-cert           skip certificate generation when certificate exists, must specify when deploying with an existing certificate"
